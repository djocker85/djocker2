...
#ANTIJS_V2
#cl = LineClient()
cl = LineClient(authToken='ExlFVWk6JhsV3PoQCgj4.28OPyozGTUT2TYgbZpkaba.ppt0fUAHxYrD5LRWJIXdIGCeG3qCnB6m255SDN5NoDM=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='ExpznGcrqcfda0GmBAt5.POObgEAhDQSALQhvbilRbq.CQl+cUImEIBTbKMv55WipAVHdvD8SJ4mbJViIsQAe68=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='Exlfn8YW5ouHa1LC81I1.Zx/jqPOOQtgLysR/5vWQqq.VNJeeMJVfz89iVS0Tb0pV5rZ92C+U7hNfKK0P4SIszg=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='ExBRjDmWcffCMt3KCHS3.ICRMHzA+le3yIlNmy2krCW.RUid5szxvZoaOmFHP75DBPT5+me+MpvT0DBAryLBjKE=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='ExYcuOAzzkP9BN6XXiD0.rPXZMVS6tbUuEeW7wVrdqa.FEZ5Sz/TcGI4kNIdya+LtPYi8jYwegA2pY9kzcd0uHQ=')
...
poll = LinePoll(cl)
call = cl
creator = ["udbca2960e660b6eb76b72181ccf28004"]
owner = ["udbca2960e660b6eb76b72181ccf28004"]
admin = ["udbca2960e660b6eb76b72181ccf28004"]
staff = ["udbca2960e660b6eb76b72181ccf28004"]
...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"Μárí gábúñg çhát kák 😊",
    "Respontag":"býúhhhh,,,,₱éñgíñ đíçi₱ók ¥áá ñgétág ñgétág áím",
    "welcome":"Selamat datang & semoga betah",
    "comment":"Like like & like by đjóçkér",
